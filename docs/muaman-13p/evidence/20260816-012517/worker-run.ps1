...
& 'C:\dev\muaman.worktrees\i-tech-productization-t0\tools\muaman13p\fresh_user_worker.ps1' -RunId $RunId -ExpectedUserName $ExpectedUserName -InstallerPath $InstallerPath -WorkRoot $WorkRoot -EvidenceRoot $EvidenceRoot -UiStringsPath $UiStringsPath -ConfigPath $ConfigPath -ReferenceDir $ReferenceDir *> 'C:\mu13o-acceptance\m13p\run\20260816-012517\worker-capture.txt'
