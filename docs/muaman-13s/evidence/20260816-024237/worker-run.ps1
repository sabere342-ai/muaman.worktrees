...
& 'C:\m13s-acceptance\run\20260816-024237\worker\consumer_worker.ps1' -RunId $RunId -ExpectedUserName $ExpectedUserName -ConsumerWorkspace $ConsumerWorkspace -StagedZip $StagedZip -EvidenceRoot $EvidenceRoot -UiStringsPath $UiStringsPath -ConfigPath $ConfigPath *> 'C:\m13s-acceptance\run\20260816-024237\worker-capture.txt'
